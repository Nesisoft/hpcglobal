...
const ROLES = ['SUPER_ADMIN', 'CONTENT_EDITOR', 'MEDIA_MANAGER'];
const ROLE_COLORS = {
...
const EMPTY_FORM = { name: '', email: '', role: 'CONTENT_EDITOR', password: '', confirmPassword: '' };
...
export default function AdminUsers() {
  ...
  function openEdit(row) {
    setEditTarget(row);
    setForm({ name: row.name, email: row.email, role: row.role, password: '', confirmPassword: '' });
    setShowPw(false);
    setError('');
    setModalOpen(true);
  }
